<link rel="stylesheet" class="aplayer-secondary-style-marker" href="/assets/css/APlayer.min.css"><script src="/assets/js/APlayer.min.js" class="aplayer-secondary-script-marker"></script><script class="meting-secondary-script-marker" src="/assets/js/Meting.min.js"></script>let index = 0;
let origin = 'zhihu';
...
function first_xhr () {
    ...
    xhr_zhihu.open('GET', 'https://news.pigp.repl.co/api?_vercel_no_cache=1' + '&cache=' + now_time);
    xhr_zhihu.onload = zhihu_first_load;
    xhr_zhihu.onerror = handleError_zhihu;
    xhr_zhihu.send();
    const xhr_163 = new XMLHttpRequest();
    xhr_163.open('GET', 'https://news.pigp.repl.co/api?origin=163&_vercel_no_cache=1'+ '&cache=' + now_time);
